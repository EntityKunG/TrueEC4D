...
public enum Sound1_8_to_1_13 {
    AMBIENCE_CAVE("AMBIENCE_CAVE", "AMBIENT_CAVE"),
    AMBIENCE_RAIN("AMBIENCE_RAIN", "WEATHER_RAIN"),
    AMBIENCE_THUNDER("AMBIENCE_THUNDER", "ENTITY_LIGHTNING_BOLT_IMPACT"),
    ...
    private String to113sound;
    private Sound resolvedSound = null;

    Sound1_8_to_1_13(String pre19sound, String to113sound) {
        this.pre19sound = pre19sound;
        this.to113sound = to113sound;
    }
    ...
    public Sound bukkitSound() {
        ...
        try {
            return resolvedSound = Sound.valueOf(to113sound);
